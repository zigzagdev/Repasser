        ...
        <form method="post">
          ...
          <div class="admin_name">
            <label for="item_name">Item Name</label>
              <?php dd($item); ?>
            <input type="text" id="item_name" name="item_name" class="name_css" style="width: 320px; height: 30px" value="{{($items->item_name)}}" placeholder="20文字以内">
          </div>
          ...
          <div class="email_around">
            ...
            <textarea rows="8" cols="40" name="item_content" placeholder="Write some product description">{{($items->item_content)}}</textarea>
          </div>
          <div class="email_around">
          ...
          <div class="base_button">
            <a href="{{url('admin/deedShowItem/'.$items->id)}}">
              <button type="submit" class="editac_btn" style="margin-left: 120px; margin-top: 10px; margin-bottom: 20px">Edit Submit</button>
            </a>
