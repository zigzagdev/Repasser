...
//  item_edit
Route::get(' admin/item/deedEditItem/{admin_id}/{item_name}','ItemController@deedEditItem');

// item_update_function
Route::put(' admin/item/deedEditItem/{admin_id}/{item_name}','ItemController@deedUpdateitem');
